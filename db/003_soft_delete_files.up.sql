...
CREATE INDEX IF NOT EXISTS idx_filemanager_files_user_id_deleted
    ON filemanager_files(user_id, deleted);

-- Ensure updated_at changes when deleted flag is toggled
CREATE TRIGGER IF NOT EXISTS filemanager_files_set_updated_at_on_deleted
